...
Caption rules:
- 1-2 short sentences, punchy, no fluff — MUST be under 150 characters
  before hashtags, this is a hard limit (leaves room for hashtags + the CTA
  link appended after)
- End with a short, sharp hook or question — not a hard sell
- ALWAYS end with 2-3 relevant hashtags for discoverability — this is how
  people in this niche actually find posts. Pick specific ones tied to the
  story (e.g. #Warhammer40k, #DnD, #TTRPG, #Wargaming, #BoardGames,
  #Kickstarter) over generic ones. Not optional.
